...
# SOFTWARE PATHS
searchlight_dir="/mnt/data/project0062/proseg_data/software_ext/SearchLight2"
...
celltypes_dir="/mnt/data/project0062/proseg_data/results/comb/niches_de" # celltypes dir
ss_path="/mnt/data/project0062//proseg_data/data/sample_sheet/SL2_sample_sheet.tsv"
...
do
    ...
    echo ${celltype}
    out_dir="${celltypes_dir}/${celltype}/SL2_results_bc"
    rm -rf ${out_dir}
    mkdir -p ${out_dir}
    ...
    --bg  file="${bg_path}" \
    --em  file="${celltypes_dir}/${celltype}/bc_${celltype}.tsv" \
    --ss  file="${ss_path}" \
